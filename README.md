...
<b>Note:</b> &nbsp; how to [upload large files to GitHub repository](https://medium.com/linkit-intecs/how-to-upload-large-files-to-github-repository-2b1e03723d2) using <b>git lfs</b> 
<br/>
<br/>
## Process Overview
